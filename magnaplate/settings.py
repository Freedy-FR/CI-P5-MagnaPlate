"""
Django settings for magnaplate project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'products.context_processors.global_collections_and_creators',
                'products.context_processors.sorting_options',
            ],
            'builtins': [
...
WSGI_APPLICATION = 'magnaplate.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'magnaplatep5'
...
DEFAULT_FROM_EMAIL = 'magnaplate.web@gmail.com'
