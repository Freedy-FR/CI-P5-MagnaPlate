...
urlpatterns = [
    ...
    path(
        'toggle_product/<int:id>/',
        ToggleFavoriteProductView.as_view(),
        name='toggle_favorite_product'
    ),
    path(
        'toggle_creator/<int:id>/',
        ToggleFavoriteCreatorView.as_view(),
        name='toggle_favorite_creator'
    ),
]
